...

      {
        session?.user.id === post.creator._id && pathName === '/profile' && (
          <div className="mt-5 flex-center  gap-4 border-t border-gray-100 pt-3">
            <p className="font-inter text-sm font-bold text-blue-500 cursor-pointer" onClick={handleEdit}>
              Edit
            </p>
            <p className="font-inter text-sm font-bold text-red-500 cursor-pointer" onClick={handleDelete}>
              Delete
            </p>
          </div>
        )
